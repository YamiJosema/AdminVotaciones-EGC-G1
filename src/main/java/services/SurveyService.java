...
public class SurveyService {
	...
	public Integer save(Survey s,String user) {
		...
		//if (s.getStartDate() == null || s.getEndDate() == null || s.getName() == "" || s.getTipo() == null) {
		if(s.getName() == ""){
...
//	}
	...
	public Survey findOne(int id) {
		Assert.isTrue(id!=0, "commit.illegalOp1");
	//	Assert.isTrue(surveyRepository.exists(id), "commit.illegalOp2");
